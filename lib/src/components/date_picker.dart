...
class _ShadDatePickerState extends State<ShadDatePicker> {
  ...
  // Prevents duplicate onChanged/onRangeChanged calls when a local selection
  // first updates the controller and then comes back through its listener.
  ...
  void initState() {
    ...
    if (widget.controller == null) {
      ...
      } else if (widget.selectedRange != null) {
        _controller = ShadCalendarController.range(
  ...
  void didUpdateWidget(covariant ShadDatePicker oldWidget) {
    ...
    if (oldWidget.controller != widget.controller) {
      ...
      if (widget.controller == null) {
        if (previousController?.selected != null || widget.selected != null) {
          _controller = ShadCalendarController(
            selected: previousController?.selected ?? widget.selected,
          );
        } else if (
          previousController?.selectedRange != null
          ...
          previousController?.multipleSelected != null
          || widget.multipleSelected != null
        ) {
          _controller = ShadCalendarController.multiple(
            selected:
