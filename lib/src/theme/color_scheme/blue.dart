...
class ShadBlueColorScheme extends ShadColorScheme {
  ...
  const ShadBlueColorScheme.light({
    ...
    super.sidebarBackground = const Color(0xFFfafafa),
    ...
    super.sidebarPrimary = const Color(0xFF2B7FFF),
    super.sidebarPrimaryForeground = const Color(0xFFEFF6FF),
    super.sidebarRing = const Color(0xFF1C398E),
    super.custom,
  });
  ...
  const ShadBlueColorScheme.dark({
    ...
    super.sidebarBackground = const Color(0xFF18181b),
    ...
    super.sidebarPrimary = const Color(0xFF155DFC),
    super.sidebarPrimaryForeground = const Color(0xFFEFF6FF),
    super.sidebarRing = const Color(0xFF51A2FF),
    super.custom,
  });
}
