...
@immutable
class ShadcnVioletColorScheme extends ShadcnColorScheme {
  const ShadcnVioletColorScheme({
  ...
  const ShadcnVioletColorScheme.light({
  ...
  const ShadcnVioletColorScheme.dark({
