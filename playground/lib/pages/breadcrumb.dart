  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: Center(
          child: switch (style) {
            ShadBreadcrumbStyle.primary => PrimaryBreadcrumb(),
            ShadBreadcrumbStyle.customSeparator => CustomSeparatorBreadcrumb(),
            ShadBreadcrumbStyle.dropdown => DropdownBreadcrumb(),
          },
        ),
      ),
    );
