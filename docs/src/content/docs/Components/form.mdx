...
If your `ShadForm` has an initial value like this one `{'date': '2024-02-01'}` you need to convert the string value to a `DateTime` object for the `ShadDatePickerFormField`.
```dart {3}
